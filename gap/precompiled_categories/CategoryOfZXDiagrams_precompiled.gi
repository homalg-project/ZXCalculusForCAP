...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return Length( deduped_5_1 ) = Length( deduped_6_1 ) and Length( deduped_7_1 ) = Length( deduped_8_1 ) and (List( deduped_7_1, function ( a_2 )
                  ...
                  end )) and deduped_10_1[2] = deduped_9_1[2] and deduped_10_1[3] = deduped_9_1[3];
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return deduped_1_1 = deduped_2_1 and ListWithIdenticalEntries( deduped_1_1, deduped_3_1 ) = ListWithIdenticalEntries( deduped_2_1, deduped_3_1 );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return ForAll( deduped_5_1, function ( a_2 )
                  ...
                  end ) and deduped_6_1 = Length( deduped_5_1 ) and ForAll( deduped_5_1, function ( a_2 )
                    return a_2 < deduped_1_1;
                end ) and deduped_10_1 and ListWithIdenticalEntries( deduped_6_1, deduped_12_1 ) = List( [ 0 .. deduped_6_1 - 1 ], function ( i_2 )
                  return deduped_3_1[1 + deduped_5_1[1 + i_2]];
              end ) and (ForAll( deduped_7_1, function ( a_2 )
                      return IsBigInt( a_2 ) and a_2 >= 0;
                  end ) and deduped_8_1 = Length( deduped_7_1 ) and ForAll( deduped_7_1, function ( a_2 )
                    return a_2 < deduped_1_1;
                end ) and deduped_10_1 and ListWithIdenticalEntries( deduped_8_1, deduped_12_1 ) = List( [ 0 .. deduped_8_1 - 1 ], function ( i_2 )
...
function ( cat_1, arg2_1 )
    ...
    return ForAll( deduped_1_1, function ( a_2 )
                return IsBigInt( a_2 ) and a_2 >= 0;
            end ) and ForAll( deduped_1_1, function ( a_2 )
                return a_2 < 4;
            end ) and deduped_2_1 = 0;
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    deduped_37_1 := CapJitTypedExpression( [  ], function (  )
            return rec(
                filter := IsList,
                element_type := rec(
                    filter := IsInt ) );
        end );
    deduped_36_1 := VertexLabeledGraph( beta_1 );
    deduped_35_1 := VertexLabeledGraph( alpha_1 );
    deduped_34_1 := Range( beta_1 );
    deduped_33_1 := Source( alpha_1 );
    deduped_32_1 := deduped_36_1[4];
    deduped_31_1 := deduped_35_1[4];
    deduped_30_1 := deduped_36_1[1];
    deduped_29_1 := deduped_35_1[1];
    deduped_28_1 := Length( deduped_32_1 );
    deduped_27_1 := Length( deduped_31_1 );
    deduped_26_1 := Length( deduped_30_1 );
    deduped_25_1 := Length( deduped_29_1 );
    deduped_24_1 := deduped_27_1 + deduped_28_1;
    deduped_23_1 := deduped_25_1 + deduped_26_1;
    deduped_22_1 := [ 0 .. deduped_28_1 - 1 ];
    deduped_21_1 := [ 0 .. deduped_27_1 - 1 ];
    deduped_20_1 := [ 0 .. deduped_24_1 - 1 ];
    hoisted_2_1 := deduped_36_1[2];
    hoisted_1_1 := deduped_35_1[3];
    deduped_19_1 := SKELETAL_FIN_SETS_ExplicitCoequalizer( deduped_23_1, [ List( [ 0 .. AsInteger( Range( alpha_1 ) ) - 1 ], function ( i_2 )
                  return hoisted_1_1[1 + i_2];
              end ), List( [ 0 .. AsInteger( Source( beta_1 ) ) - 1 ], function ( i_2 )
                  return deduped_25_1 + hoisted_2_1[1 + i_2];
              end ) ] );
    deduped_18_1 := Concatenation( List( deduped_21_1, function ( i_2 )
              return CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_INCOMPLETE_LOGIC( deduped_31_1[1 + i_2] )[2] );
          end ), List( deduped_22_1, function ( i_2 )
              return deduped_25_1 + CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_INCOMPLETE_LOGIC( deduped_32_1[1 + i_2] )[2] );
          end ) );
    deduped_17_1 := Concatenation( List( deduped_21_1, function ( i_2 )
              return CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_INCOMPLETE_LOGIC( deduped_31_1[1 + i_2] )[1] );
          end ), List( deduped_22_1, function ( i_2 )
              return deduped_25_1 + CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_INCOMPLETE_LOGIC( deduped_32_1[1 + i_2] )[1] );
          end ) );
    hoisted_15_1 := ListN( deduped_17_1, deduped_18_1, function ( s_2, t_2 )
            return t_2;
        end );
    deduped_5_1 := List( [ 0 .. deduped_23_1 - 1 ], function ( x_2 )
    ...
    hoisted_14_1 := List( deduped_20_1, function ( i_2 )
            return deduped_5_1[1 + hoisted_13_1[1 + i_2]];
        end );
    hoisted_10_1 := List( [ 0 .. deduped_26_1 - 1 ], function ( i_2 )
            return deduped_5_1[1 + (deduped_25_1 + i_2)];
        end );
    hoisted_9_1 := deduped_36_1[3];
    hoisted_8_1 := List( [ 0 .. deduped_25_1 - 1 ], function ( i_2 )
            return deduped_5_1[1 + i_2];
        end );
    hoisted_7_1 := deduped_35_1[2];
    hoisted_6_1 := Concatenation( deduped_29_1, deduped_30_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_33_1, deduped_34_1, VertexLabeledGraph, NTuple( 4, List( [ 0 .. BigInt( Length( deduped_19_1 ) ) - 1 ], function ( y_2 )
                ...
                return;
            end ), List( [ 0 .. AsInteger( deduped_33_1 ) - 1 ], function ( i_2 )
                return hoisted_8_1[1 + hoisted_7_1[1 + i_2]];
            end ), List( [ 0 .. AsInteger( deduped_34_1 ) - 1 ], function ( i_2 )
                return hoisted_10_1[1 + hoisted_9_1[1 + i_2]];
            end ), List( SKELETAL_FIN_SETS_ExplicitCoequalizer( deduped_24_1, [ deduped_37_1, deduped_37_1 ] ), function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + x_2[1];
                return NTuple( 2, hoisted_14_1[deduped_1_2], hoisted_16_1[deduped_1_2] );
            end ) ) );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    deduped_39_1 := CapJitTypedExpression( [  ], function (  )
            return rec(
                filter := IsList,
                element_type := rec(
                    filter := IsInt ) );
        end );
    deduped_38_1 := VertexLabeledGraph( beta_1 );
    deduped_37_1 := VertexLabeledGraph( alpha_1 );
    deduped_36_1 := Range( beta_1 );
    deduped_35_1 := Source( alpha_1 );
    ...
    deduped_21_1 := Concatenation( List( deduped_23_1, function ( i_2 )
              return hoisted_13_1[1 + i_2];
          end ), List( deduped_24_1, function ( i_2 )
              return deduped_27_1 + hoisted_14_1[1 + i_2];
          end ) );
    hoisted_12_1 := List( deduped_34_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_11_1 := List( deduped_33_1, function ( a_2 )
            return a_2[1];
        end );
    deduped_20_1 := Concatenation( List( deduped_23_1, function ( i_2 )
              return hoisted_11_1[1 + i_2];
          end ), List( deduped_24_1, function ( i_2 )
              return deduped_27_1 + hoisted_12_1[1 + i_2];
          end ) );
    hoisted_2_1 := deduped_38_1[2];
    hoisted_1_1 := deduped_37_1[3];
    deduped_19_1 := SKELETAL_FIN_SETS_ExplicitCoequalizer( deduped_25_1, [ List( [ 0 .. AsInteger( Range( alpha_1 ) ) - 1 ], function ( i_2 )
                  return hoisted_1_1[1 + i_2];
              end ), List( [ 0 .. AsInteger( Source( beta_1 ) ) - 1 ], function ( i_2 )
                  return deduped_27_1 + hoisted_2_1[1 + i_2];
              end ) ] );
    hoisted_17_1 := ListN( deduped_20_1, deduped_21_1, function ( s_2, t_2 )
            return t_2;
        end );
    ...
    hoisted_15_1 := ListN( deduped_20_1, deduped_21_1, function ( s_2, t_2 )
            return s_2;
        end );
    ...
    hoisted_9_1 := deduped_38_1[3];
    hoisted_8_1 := List( [ 0 .. deduped_27_1 - 1 ], function ( i_2 )
            return deduped_5_1[1 + i_2];
        end );
    hoisted_7_1 := deduped_37_1[2];
    hoisted_6_1 := Concatenation( deduped_31_1, deduped_32_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_35_1, deduped_36_1, VertexLabeledGraph, NTuple( 4, List( [ 0 .. BigInt( Length( deduped_19_1 ) ) - 1 ], function ( y_2 )
                if not y_2 in deduped_5_1 then
                    return "neutral";
                else
                    return hoisted_6_1[SafePosition( deduped_5_1, y_2 )];
                ...
                return;
            end ), List( [ 0 .. AsInteger( deduped_35_1 ) - 1 ], function ( i_2 )
                return hoisted_8_1[1 + hoisted_7_1[1 + i_2]];
            end ), List( [ 0 .. AsInteger( deduped_36_1 ) - 1 ], function ( i_2 )
                return hoisted_10_1[1 + hoisted_9_1[1 + i_2]];
            end ), List( SKELETAL_FIN_SETS_ExplicitCoequalizer( deduped_26_1, [ deduped_39_1, deduped_39_1 ] ), function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + x_2[1];
                return NTuple( 2, hoisted_16_1[deduped_1_2], hoisted_18_1[deduped_1_2] );
            end ) ) );
end
########
