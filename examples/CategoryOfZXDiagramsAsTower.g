...
zero := 0 / zx;
#! <An object in CategoryOfZXDiagramsAsTower( ) representing 0 input/output\
#!  vertices>
one := 1 / zx;
#! <An object in CategoryOfZXDiagramsAsTower( ) representing 1 input/output\
#!  vertices>
two := 2 / zx;
#! <An object in CategoryOfZXDiagramsAsTower( ) representing 2 input/output\
#!  vertices>
three := 3 / zx;
#! <An object in CategoryOfZXDiagramsAsTower( ) representing 3 input/output\
#!  vertices>
...
#! <An identity morphism in CategoryOfZXDiagramsAsTower( )>
ev := EvaluationForDual( three );
#! <A morphism in CategoryOfZXDiagramsAsTower( )>
...
#! A morphism in CategoryOfZXDiagramsAsTower( ) given by a ZX-diagram \
